...
$conn = new PDO('pgsql:host=localhost; dbname=ccs', 'michael', 'huskies1975');


# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = 'SELECT *, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM monitor_monitorstation';
